<div align="center">
  ...
  <p align="center">
    ...
    <a href=".github/workflows/all-in-one-automation.yml"><img src="https://img.shields.io/badge/Workflows-All--in--One%20Action-blue?style=flat-square&logo=githubactions&logoColor=white" alt="Workflows" /></a>
...
5. Salin workflow **[`.github/workflows/all-in-one-automation.yml`](.github/workflows/all-in-one-automation.yml)** ke repositori Anda agar Snake animation & Blog sync berjalan otomatis!
...
1. **[`.github/workflows/all-in-one-automation.yml`](.github/workflows/all-in-one-automation.yml)** — Menjalankan Snake Game + 3D Graph + Blog RSS sekaligus.
2. **[`.github/workflows/snake-contribution.yml`](.github/workflows/snake-contribution.yml)** — Khusus animasi Snake Game SVG (Light & Dark).
3. **[`.github/workflows/blog-post-sync.yml`](.github/workflows/blog-post-sync.yml)** — Khusus sinkronisasi RSS Blog.
4. **[`.github/workflows/profile-3d-contrib.yml`](.github/workflows/profile-3d-contrib.yml)** — Khusus grafik kontribusi 3D isometrik.
